...
EVALMI_BASELINE_CKPT_PATH = (
    "/storage/users/rajivs/anatapmitra/pretraining/evalmi_baseline_qf_ver1.pth"
)

# AIGIQA-20K target/test database.
A20K_TEST_CSV = (
    "/home/rajivs/anatapmitra/anatap_data/generated_descriptions_PT1/Evalmi_new/evalmi_test_full_gen_responses_PT1.csv"
)

A20K_IMG_ROOT = (
    "/home/rajivs/anatapmitra/anatap_data/anatap_1/public_datasets/EvalMi-50K"
)
...
def main() -> None:
    print("CROSS-DATABASE EVALUATION: EvalMI baseline ver2 Q-Former -> A3K test set")
    ...
    print("============================================================")
    print(f"Number of evaluated A3K test images : {len(test_dataset)}")
    print(f"EVALMI test SROCC ON new pretraning chkpt for baseline qf: {test_srcc:.6f}")
    print("============================================================")
