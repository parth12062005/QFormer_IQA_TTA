...
A20K_TEST_CSV = (
    "/home/rajivs/anatapmitra/anatap_data/generated_descriptions_PT1/QEval_new/qeval_test_full_gen_responses_PT1_normalized.csv"
)

A20K_IMG_ROOT = (
    "/storage/users/rajivs/anatapmitra/Dataset"
)
...
def main() -> None:
    print("CROSS-DATABASE EVALUATION: EvalMI baseline ver2 Q-Former -> QEVAL test set")
    ...
    print("============================================================")
    print(f"Number of evaluated QEVAL test images : {len(test_dataset)}")
    print(f"QEVAL test SROCC                      : {test_srcc:.6f}")
    print("============================================================")
