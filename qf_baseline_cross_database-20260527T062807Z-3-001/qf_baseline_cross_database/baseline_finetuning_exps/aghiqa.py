...
# read the train csv  
fraction = 0.1
train_df = pd.read_csv("/storage/users/rajivs/anatapmitra/AGHI-QA/train_test_split/aghiqa_train_full_gen_responses_PT1.csv")
train_labeld_df = train_df.sample(frac=fraction, random_state=SEED).reset_index(drop=True)
 
# now get the val and test csv
val_csv = "/storage/users/rajivs/anatapmitra/AGHI-QA/train_test_split/aghiqa_val_full_gen_responses_PT1.csv"
val_df = pd.read_csv("/storage/users/rajivs/anatapmitra/AGHI-QA/train_test_split/aghiqa_val_full_gen_responses_PT1.csv")
test_csv = "/storage/users/rajivs/anatapmitra/AGHI-QA/train_test_split/aghiqa_test_full_gen_responses_PT1.csv"
test_df = pd.read_csv("/storage/users/rajivs/anatapmitra/AGHI-QA/train_test_split/aghiqa_test_full_gen_responses_PT1.csv")

# now get the image_root 
image_root = "/storage/users/rajivs/anatapmitra/AGHI-QA/images/images"

test_out_csv = "/home/rajivs/anatapmitra/anatap_data/Analysis_EXP/check_aghiqa_qf_bs_ft_v234.csv"
