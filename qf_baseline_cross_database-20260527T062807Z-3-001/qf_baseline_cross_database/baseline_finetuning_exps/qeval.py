...
# read the train csv  
fraction = 0.1
train_df = pd.read_csv("/home/rajivs/anatapmitra/anatap_data/generated_descriptions_PT1/QEval_new/qeval_train_full_gen_responses_PT1_normalized.csv")
train_labeld_df = train_df.sample(frac=fraction, random_state=SEED).reset_index(drop=True)
 
# now get the val and test csv
val_csv = "/home/rajivs/anatapmitra/anatap_data/generated_descriptions_PT1/QEval_new/qeval_val_full_gen_responses_PT1_normalized.csv"
val_df = pd.read_csv("/home/rajivs/anatapmitra/anatap_data/generated_descriptions_PT1/QEval_new/qeval_val_full_gen_responses_PT1_normalized.csv")
test_csv = "/home/rajivs/anatapmitra/anatap_data/generated_descriptions_PT1/QEval_new/qeval_test_full_gen_responses_PT1_normalized.csv"
test_df = pd.read_csv("/home/rajivs/anatapmitra/anatap_data/generated_descriptions_PT1/QEval_new/qeval_test_full_gen_responses_PT1_normalized.csv")

# now get the image_root 
image_root = "/storage/users/rajivs/anatapmitra/Dataset"

test_out_csv = "/home/rajivs/anatapmitra/anatap_data/Analysis_EXP/check_qeval_qf_bs_ft_v234.csv"
