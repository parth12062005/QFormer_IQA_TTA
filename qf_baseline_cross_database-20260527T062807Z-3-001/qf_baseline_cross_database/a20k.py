...
A20K_TEST_CSV = (
    ...
    "generated_descriptions_PT1/A20K_new/A20k_test_full_PT1_normalized.csv"
)

A20K_IMG_ROOT = (
    "/home/rajivs/anatapmitra/anatap_data/"
    "anatap_1/aigiqa-20k/Images/train"
)
...
def main() -> None:
    print("CROSS-DATABASE EVALUATION: EvalMI baseline ver2 Q-Former -> A20K test set")
    ...
    print("============================================================")
    print(f"Number of evaluated A20K test images : {len(test_dataset)}")
    print(f"A20K test SROCC                      : {test_srcc:.6f}")
    print("============================================================")
