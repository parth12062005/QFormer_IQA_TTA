...
##### ----------------- ####
def main():
    print("PRETRAINING FOR QFORMER + DESCRIPTION REGULARIZATION (Qinstruct) ON EVALMI")
    train_dataset = QFormerQualityDataset(
        csv_path="/home/rajivs/anatapmitra/anatap_data/Benckmarking/Qinstruct_MLLM/new_qinstruct_outputs/evalmi_train_full_qinstruct_descriptions.csv",
    ...
    checkpoint_path = "/home/rajivs/anatapmitra/anatap_data/Qformer_experiments/new_pretraining/evalmi_qf_desc_reg_qinstruct.pth"
    os.makedirs(os.path.dirname(checkpoint_path), exist_ok=True)

    best_srcc, best_test_srcc = -1.0, -1.0
    train_out_csv = "/home/rajivs/anatapmitra/anatap_data/Qformer_experiments/new_pretraining/evalmi_qf_desc_reg_train_pt1_qwen3vl.csv"
    test_out_csv = "/home/rajivs/anatapmitra/anatap_data/Qformer_experiments/new_pretraining/evalmi_qf_desc_reg_test_pt1_qwen3vl.csv"
